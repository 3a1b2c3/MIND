...
"%PY%" "%~dp0run_dreamx.py" "%LOG%" "%PY%" "src\drive_lingbot.py" "--gt-root" "%GT_ROOT%" "--test-root" "%MIND_TESTS%" "--model-name" "%MODEL_NAME%" "--ckpt-dir" "%CKPT_DIR%" "--fps" "%MIND_FPS%" "--perspective" "1st_data" %MIRROR_ARG% %*
